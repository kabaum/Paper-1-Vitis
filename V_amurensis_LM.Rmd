...
```{r}
am_tap13_plot <- ggplot(am_13, aes(x = leaf, y = tooth.area.perimeter)) + geom_smooth() + theme_classic() + scale_x_continuous(breaks = seq(0, 13, 1))
...
```{r}
am_taip15_plot <- ggplot(am_15, aes(x = leaf, y = tooth.area.int.perimeter)) + geom_smooth() + theme_classic() + scale_x_continuous(breaks = seq(0, 13, 1))
...
```{r}
am_ata13_plot <- ggplot(am_13, aes(x = leaf, y = average.tooth.area)) + geom_smooth() + theme_classic() + scale_x_continuous(breaks = seq(0, 13, 1))
...
```{r}
am_ata15_plot <- ggplot(am_15, aes(x = leaf, y = average.tooth.area)) + geom_smooth() + theme_classic() + scale_x_continuous(breaks = seq(0, 13, 1))
