...
summary(pca_ac_all)
loadings(pca_ac_all)
scores_pca_ac <- scores(pca_ac_all)
scores_pca_ac_df <- as.data.frame(scores_pca_ac)
str(scores_pca_ac_df)
#ggplot(scores_pca_ac_df, aes(x = PC1, y = PC2, label = rownames(scores_pca_ac_df))) +
